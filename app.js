...
const sessionStore = new MongoDBStore({
  // instantiation of the MongoDBStore constructor
...
app.use(async function (req, res, next) {
  ...
  if (!user || !isAuth) {
    return next(); // if the user doesnt exist or is not authenticated, it will go next, ie to the next bit of middleware, demoroutes.
  }
  ...
  res.locals.isAuth = isAuth; // setting the user to be auth and admin, but GLOBALLY
